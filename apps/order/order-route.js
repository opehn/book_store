...
var order_controller_str_1 = require("./stratified-architecture/order-controller.str");
/* 주문 목록 조회 */
router.get('/', [
    jwt_1.default.verifyToken,
], order_controller_str_1.default.getOrderList)
    .post('/', /* 결제 하기 */ [
    //TODO : 괴랄함 해결하기..
    (0, express_validator_1.checkSchema)(validation_schema_1.paymentSchema),
    jwt_1.default.validate,
    jwt_1.default.verifyToken,
], order_controller_str_1.default.orderPayment)
    .get('/:orderId', /* 주문 상세 조회 */ [
    jwt_1.default.verifyToken,
], order_controller_str_1.default.getOrderDetail);
