...
var getCartList = function (req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, response, data, message, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, cart_db_1.default.selectCartByUser(userId)];
                case 2:
                    data = _a.sent();
                ...
                case 3:
                    e_1 = _a.sent();
                    response = util_1.default.makeResponse(null, 'Error', e_1.message);
...
var addCart = function (req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, bookId, count, userId, sign, response, data, message, e_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, cart_db_1.default.updateOrInsertCartItem(userId, bookId, count, sign)];
                case 2:
                    data = _b.sent();
                    message = util_1.default.makeMessage(data);
                ...
                case 3:
                    e_2 = _b.sent();
                    response = util_1.default.makeResponse(null, 'Error', e_2.message);
                    res.status(500).json(response);
