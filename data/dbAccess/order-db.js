                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, connection_1.default)('ORDERS_TB as ot')
                                .select('created_at', 'book_title', 'total_count', 'total_price', 'delivery_id', 'dt.id', 'address', 'receiver', 'contact').where('ot.user_id', userId)
                        ...
                        return [4 /*yield*/, connection_1.default.transaction(function (trx) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 2:
                                            orderId = _a.sent();
                                            newItems = body.items.map(function (cur) { return ({
                                                'book_id': cur.bookId,
                                                'count': cur.count,
                                                'order_id': orderId
                                            }); });
